...
import { X, Save, UserCircle, Mail, Phone, Lock, Eye, EyeOff, Map, MapPin, User, Users, Info, Briefcase, CheckCircle2, Trash2, Tag } from 'lucide-react';
  ...
  useEffect(() => {
    if (isOpen) {
      if ((mode === 'detail' || mode === 'view_only') && data) {
        ...
        setKodeSalesman(data.kodeSalesman || 'SLS-001');
      } else {
        setNamaSales('');
        setUsername('');
        setEmail('');
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="text" 
                    value={kodeSalesman}
                    onChange={(e) => setKodeSalesman(e.target.value)}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      readOnly={mode === 'view_only'}
                      className={`w-full pl-10 pr-12 py-2.5 text-[14px] bg-white border border-gray-200 rounded-xl text-gray-800 focus:outline-none transition-colors ${mode !== 'view_only' ? 'focus:border-[#3b0764] focus:ring-1 focus:ring-[#3b0764]' : ''}`}
                    />
                    <div 
