...
export const DashboardPage = () => {
  const { 
    dateRange, location, distributor, product,
    setDateRange, setLocation, setDistributor, setProduct
  } = useFilterStore();

  const dateOptions = [
    'Januari 1 - Januari 31, 2026',
    'Februari 1 - Februari 28, 2026',
    'Maret 1 - Maret 31, 2026',
      ...
      <div className="px-8 pb-10">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            ...
            <div>
              <label className="block text-sm text-gray-500 mb-2">Distributor</label>
              <CustomSelect 
                value={distributor} 
            ...
            <div>
              <label className="block text-sm text-gray-500 mb-2">Produk</label>
              <CustomSelect 
                value={product} 
                onChange={setProduct} 
